        ...
        <nav id="sidebar" class="sidebar js-sidebar">
            <div class="sidebar-content js-simplebar">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item {{ (request()->is('pengaduan-admin')) ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{ url('pengaduan-admin') }}">
                            <i class="align-middle" data-feather="user"></i> <span class="align-middle">Pengaduan</span>
                        </a>
                    </li>

                    <li class="sidebar-item {{ (request()->is('tanggapan')) ? 'active' : '' }}">
                    ...
                    <li class="sidebar-item {{ (request()->is('petugas')) ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{route('petugas.index')}}">
                            <i class="align-middle" data-feather="user-plus"></i> <span
                                class="align-middle">Petugas</span>
                        </a>
                    </li>

                    <li class="sidebar-item {{ (request()->is('masyarakat')) ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{route('masyarakat.index')}}">
                            <i class="align-middle" data-feather="book">s</i> <span
                                class="align-middle">Masyarakat</span>
                        </a>
                    </li>
                    ...
                    <li class="sidebar-item {{ (request()->is('petugas-pengaduan')) ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{url('petugas-pengaduan')}}">
                            <i class="align-middle" data-feather="check-square"></i> <span
                                class="align-middle">Pengaduan</span>
                        </a>
                    </li>
                    <li class="sidebar-item {{ (request()->is('pengaduan-verifikasi')) ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{url('pengaduan-verifikasi')}}">
                            <i class="align-middle" data-feather="check-square"></i> <span
                                class="align-middle">Terverifikasi</span>
                        </a>
                    </li>
                    ...
                    <li class="sidebar-item {{ (request()->is('pengaduan-selesai')) ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{url('pengaduan-selesai')}}">
                            <i class="align-middle" data-feather="check-square"></i> <span
                                class="align-middle">Selesai</span>
                        </a>
                    </li>
                    @endif
                    ...
                    <ul class="navbar-nav navbar-align">
                        <li class="nav-item dropdown">
                            ...
                            <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#"
                                data-bs-toggle="dropdown">
                                <img src="https://ui-avatars.com/api/?name={{ $di }}?background=random"
                                    class="avatar img-fluid rounded me-1" alt="Jhoni Jhon" /> <span class="text-dark">
                                    {{ $di }}
                                </span>
                            </a>
